...
<html lang="ru">
    ...
    <body>
        <p>Здравствуйте, пропуск {{ $pass['truck_num'] }} - Аннулирован {{ date("d.m.Y", strtotime($pass['cancel_date'])) }}" Рекомендуем ограничить поездки по МКАД и внутри Москвы для избежания штрафов.</p>
